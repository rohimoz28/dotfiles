                                                                        ...
                                                                        -- {{{ Mouse bindings
                                                                                    ...
                                                                                    -- {{{ Key bindings
                                                                                                globalkeys = my_table.join(
                                                                                                    ...
                                                                                                    awful.key({ altkey }, "p", function() os.execute("flameshot") end,
                                                                                                ...
                                                                                                -- Standard program
                                                                                                awful.key({ }, "F5", function () awful.util.spawn("xscreensaver-command -lock") end), 
                                                                                                ...
                                                                                                --[[awful.key({ modkey }, "e", function () awful.spawn(tEditor) end,]]
                                                                                                --[[{description = "run tEditor", group = "launcher"})]]
                                                                                                awful.key({ modkey }, "e", function ()awful.util.spawn("kitty -e tmux") end),
